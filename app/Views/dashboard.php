...
<head>
    ...
    <meta name="title" content="Blackshark" />
                ...
                <ul class="navbar-nav ms-auto">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                            <a href="#" class="dropdown-item">
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0">
                                        <img
                                            src="<?= base_url() ?>/template/dist/assets/img/user1-128x128.jpg"
                                            alt="User Avatar"
                            ...
                            <a href="#" class="dropdown-item">
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0">
                                        <img
                                            src="<?= base_url() ?>/template/dist/assets/img/user8-128x128.jpg"
                                            alt="User Avatar"
                                            class="img-size-50 rounded-circle me-3" />
                                    </div>
                                    <div class="flex-grow-1">
                            ...
                            <a href="#" class="dropdown-item">
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0">
                                        <img
                                            src="<?= base_url() ?>/template/dist/assets/img/user3-128x128.jpg"
                                            alt="User Avatar"
                                            class="img-size-50 rounded-circle me-3" />
                                    </div>
                                    <div class="flex-grow-1">
                    ...
                    <li class="nav-item dropdown user-menu">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img
                                src="<?= base_url() ?>/template/dist/assets/img/user2-160x160.jpg"
            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2">
                    ...
                    <ul
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url() ?>/template/dist/docs/introduction.html" class="nav-link">
                                <i class="nav-icon bi bi-download"></i>
                                <p>Torpedo</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url() ?>/template/dist/docs/layout.html" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url() ?>/template/dist/docs/color-mode.html" class="nav-link">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url() ?>/template/dist/docs/components/main-header.html" class="nav-link">
                                        <i class="nav-icon bi bi-1-circle"></i>
                                        <p>Torpedo</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url() ?>/template/dist/docs/components/main-sidebar.html" class="nav-link">
                                        <i class="nav-icon bi bi-2-circle"></i>
                                        <p>Alat Test</p>
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url() ?>/template/dist/docs/browser-support.html" class="nav-link">
                                <i class="nav-icon bi bi-tools"></i>
                                <p>Spareparts</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url() ?>/template/dist/docs/how-to-contribute.html" class="nav-link">
                                        ...
                                        <ul class="contacts-list">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img
                                                        class="contacts-list-img"
                                                        src="<?= base_url() ?>/template/dist/assets/img/user7-128x128.jpg"
                                                        alt="User Avatar" />
                                                    <div class="contacts-list-info">
                                                        <span class="contacts-list-name">
                                                            Sarah Doe
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img
                                                        class="contacts-list-img"
                                                        src="<?= base_url() ?>/template/dist/assets/img/user5-128x128.jpg"
                                                        alt="User Avatar" />
                                                    <div class="contacts-list-info">
                                                        <span class="contacts-list-name">
                                                            Nora S. Vans
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img
                                                        class="contacts-list-img"
                                                        src="<?= base_url() ?>/template/dist/assets/img/user6-128x128.jpg"
                                                        alt="User Avatar" />
                                                    <div class="contacts-list-info">
                                                        <span class="contacts-list-name">
                                                            John K.
